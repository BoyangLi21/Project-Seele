@echo off
setlocal
title Project SEELE - TV world acceptance R21
pushd "%~dp0"
...
if not exist "run\saves\SEELE_TV_WORLD_PREVIEW_20260906\world_revision_r21.json" (
    echo ERROR: R21 installation is not complete in the main world yet.
    goto failed
)
...
echo Project SEELE - R21 current TV world, local manual acceptance
echo World: SEELE_TV_WORLD_PREVIEW_20260906
echo Client heap: 6 GB. Exact terrain: 24 chunks. LOD: disabled.
echo Guide: %CD%\docs\MANUAL_ACCEPTANCE_R21.md
...
:usage
echo Usage: start_eva_test_r21.bat [--check]
