...
| 朗基努斯之枪本机物品模型（`tools/make_eud_weapon_pack.py`） | EUD 1.1.0 的 Blockbench 方块模型与贴图 | 生成到 `run/resourcepacks/eva_real_model`，仅本机测试；公开发行前确认 EUD 作者署名，并遵守 CC BY-NC 4.0 |
