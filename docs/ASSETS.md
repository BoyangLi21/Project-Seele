...
| CMU Graphics Lab Motion Capture Database, subjects 02, 16, 79, 80 and 111 | [Official database](https://mocap.cs.cmu.edu/). The official FAQ explicitly permits copying, modification and redistribution without permission. ASF SHA-256: subject 02 `C9F5FF45B4437B279F58B95DACF017AFD3135373096274DF69436A9354D796CF`, subject 16 `2323F876564610F84BFBEC9B90B8EBFFB57515673B7F4A45B0FB0849AF465BDB`, subject 111 `8FE67A2163F1F70ED985E34ABE0E3FF4AF7F5DA76F2F3C178D59759CB18BBA16`; selected 120 Hz AMC/BVH hashes are recorded in the local motion inventory. | Subject 02 supplies same-performer walk, run, jump, punch and swordplay. Subject 16 adds start/stop, veer and 90-degree walk/jog/run turns. Subject 111 supplies crawl, lay-down and floor-recovery references. Subject 80 trial 03 (`shooting a gun`) supplies the captured long-gun torso/shoulder stance for the Pallet Rifle while exact Tiger hand-to-weapon contacts remain constrained; subject 79 trial 96 was screened but rejected as a rifle source. Raw ASF/AMC/BVH files remain ignored. |
