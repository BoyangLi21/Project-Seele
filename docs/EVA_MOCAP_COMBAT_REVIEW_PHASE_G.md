...
状态：**HUMAN_REJECTED**。项目负责人于 2026-09-01 拒绝全部四条候选；
它们只保留为“锁死下半身会破坏动作质量”的负面证据，禁止晋升或重新包装。
...
这不是“原样全身人体重定向”。人工审查确认锁定下半身使四条动作全部过差。
后续候选必须保留支撑脚、骨盆转动、COM 与完整回收；自动系统不得把稳定性
门禁冒充动作审美批准。
