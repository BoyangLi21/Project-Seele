@echo off
setlocal
title Project SEELE - TV world acceptance R20
pushd "%~dp0"
...
if not exist "run\saves\SEELE_TV_WORLD_PREVIEW_20260906\world_revision_r20.json" (
    echo ERROR: R20 installation is not complete in the main world yet.
    goto failed
)
...
echo Project SEELE - R20 current TV world, local manual acceptance
echo World: SEELE_TV_WORLD_PREVIEW_20260906
echo Client heap: 6 GB. Exact terrain: 24 chunks. LOD: disabled.
echo Guide: %CD%\docs\MANUAL_ACCEPTANCE_R20.md
...
:usage
echo Usage: start_eva_test_20260917_r20.bat [--check]
