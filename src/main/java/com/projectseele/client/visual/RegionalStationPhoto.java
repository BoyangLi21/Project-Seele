...
public final class RegionalStationPhoto
{
    ...
    private static final boolean R30=MODE.equals("r30-lighting-photos")||R38;
    ...
    public static void tick(TickEvent.ClientTickEvent event)
    {
        ...
        if(!world.getFileName().toString().equals(R38?"SEELE_FIELD_R38_REVIEW":R30?"SEELE_FIELD_R30_REVIEW":R16?"SEELE_TV_FACILITIES_R16":R10_MODELS?"SEELE_ANGEL_MODEL_REVIEW_R10":"SEELE_TV_WORLD_PREVIEW_20260906"))return;
        try
        {
            if(finishing)
            {
