...
public final class UNWorldR11Tour
{
    ...
    private static final boolean R26="r26-worldtour".equals(System.getProperty("projectseele.regionalBuild",""));
    ...
    @SubscribeEvent public static void tick(TickEvent.ClientTickEvent event)
    {
        ...
        if(R19?!world.equals(R26?"SEELE_R26_REVIEW":R25?"SEELE_R25_REVIEW":R24?"SEELE_R24_TV_REVIEW":R23?"SEELE_R22_REVIEW":R21?"SEELE_R21_REVIEW":R20?"SEELE_R20_REVIEW":"SEELE_R19_NATIVE_REVIEW"):!world.equals("SEELE_R11_CANONICAL_ACCEPTANCE")&&!world.equals("SEELE_TV_WORLD_PREVIEW_20260906"))throw new IllegalStateException("Native tour world boundary");
        if(++age<100)return;
        try
        {
            if(shots==null)
            {
                shots=JsonParser.parseString(Files.readString(mc.gameDirectory.toPath().resolve("projectseele-local-maps/"+(R26?"r26":R25?"r25":R24?"r24":R23?"r23":R21?"r21":R20?"r20":R19?"r19":"r11")+"_worldtour.json"))).getAsJsonArray();folder=mc.gameDirectory.toPath().resolve((R26?"../artifacts/facility_r26/native_tour_":R25?"../artifacts/facility_r25/native_tour_":R24?"../artifacts/facility_r24/native_tour_":R23?"../artifacts/facility_r23/native_tour_":R21?"../artifacts/world_repair_r21/native_tour_":R20?"../artifacts/world_rebuild_r20/native_tour_":R19?"../artifacts/world_repair_r19/native_tour_":"../artifacts/world_motion_r11/world_native_")+System.currentTimeMillis()).normalize();Files.createDirectories(folder);
