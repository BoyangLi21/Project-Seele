...
public final class FactoryR20Review
{
    ...
    public static final boolean R35="r35-factory".equals(System.getProperty("projectseele.regionalBuild",""));
    public static final String R35_WORLD="SEELE_FACTORY_R35_REVIEW";
    ...
    @SubscribeEvent public static void tick(TickEvent.ServerTickEvent event)
    {
        ...
        try
        {
            ...
            if(state==0)
            {
                ...
                if(R35)
                {
                    boolean parked=false;for(int v=0;v<3;v++)if(EvaLogisticsDirector.status(level,v).phase().equals("PARKED")){variant=v;parked=true;break;}
