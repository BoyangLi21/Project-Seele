...
EXPORTS = (
    ...
    Export("knife_heavy", "knife_heavy", "crouch_knife_heavy",
           frozenset(KNIFE_UPPER)),
    Export("lance_thrust_v07", "lance_thrust", "lance_ready",
           frozenset(LANCE_UPPER), loop=True, static=True),
    Export("lance_thrust_v07", "lance_thrust", "lance_carry",
           frozenset(LANCE_UPPER), loop=True, static=True),
    Export("lance_thrust_v07", "lance_thrust", "lance_thrust",
           frozenset(LANCE_FULL)),
    Export("lance_thrust_v07", "lance_thrust", "crouch_lance_thrust",
