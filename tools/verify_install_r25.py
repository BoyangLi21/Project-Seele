...
def main():
    ...
    with (p.MAIN/'session.lock').open('r+b') as lock:
        ...
        for name in ('nerv_routes_r24.json.gz','regional_states.json','facility_lifts_r25.json','native_transit_r25.json'):
