...
ROOT=Path(__file__).resolve().parents[1];ART=ROOT/'artifacts/facility_r28';WORLD=ROOT/'run/saves/SEELE_FIELD_R28_REVIEW';OUT=ART/'navigation'
...
def main():
    ...
    for q in old:
        ...
        cases.append(q)
    extra=[]
    for name in ('reported','airport/civil'):
    ...
    nav.PUBLIC_DOMAINS=[((-76,-474,235),(157,-356,474)),((-34,-369,-288),(115,-360,-215)),((188,-469,392),(212,-453,545))];nav.PUBLIC_PATHS=paths
