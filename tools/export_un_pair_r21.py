...
for unit in ['00','01']:
 ...
 for obj in objects:
  ...
  obj['source_task']='3569385' if unit=='00' else '3569389';obj['game_mesh']='eva_prototype' if unit=='00' else 'eva_un01'
 ...
 if 'export_all_influences' in properties:params['export_all_influences']=True
